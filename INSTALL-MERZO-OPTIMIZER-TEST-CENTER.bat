...
for %%F in (MerzoOptimizer.LocalLab.ps1 Run-Profile.ps1 local-lab-profile.json ENABLE-DESTRUCTIVE-LAB.ps1 PACK-EVIDENCE.ps1 Install-LocalLab.ps1 README.md) do (
  echo Скачиваю %%F...
