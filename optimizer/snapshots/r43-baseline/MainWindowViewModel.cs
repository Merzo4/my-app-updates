...
public sealed class MainWindowViewModel : ObservableObject, IDisposable
{
    ...
    private async Task RunDeepOptimizationScanAsync()
    {
        ...
        using(lease)
        {
            ...
            IsDeepScanning=true; SelectedOptimizationTabIndex=3; DeepScanSteps.Clear(); DeepScanProgress=0; DeepScanStatusText="Запуск проверки…";
    ...
    private void UpdateOptimizationScanSummary(bool autoScan)
    {
        ...
        var light = CountProfileAvailable("light");
        ...
        RecommendedProfileTitle = recommendedId.ToUpperInvariant();
    ...
    private Task SaveDiagnosticsAsync()
    {
        try
        {
            ...
            var zipPath = Path.Combine(rootPath, $"MerzoDiagnostics-R43-{DateTime.Now:yyyyMMdd-HHmmss}.zip");
