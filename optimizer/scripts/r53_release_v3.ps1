...
try {
    # CI-only gate modernization: the inherited gate already checks Production Rxx
    # separately, so this legacy token should validate only the exact release version.
